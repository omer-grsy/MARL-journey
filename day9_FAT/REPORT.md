...
Intermittent arızanın ilginç bir özelliği vardır: arızalı ajan bazen sağlıklı mesajlar iletmektedir. Bu durum, onu sürekli izole etmenin counterproductive olabileceğine işaret etmektedir. Nitekim deneyler, Strateji B ve C'nin bu senaryoda birbirine çok yakın performans gösterdiğini ortaya koymuştur (B: 0.651, C: 0.648).
...
**Byzantine altında Strateji A ve B'nin yetersizliği:** S3 senaryosunda A tüm seed'lerde ~0.06 kapsam değerine ulaşmıştır. Strateji B ise müfredat öğrenmesiyle 0.257'ye çıkabilmekte ancak seed'e göre yüksek varyans sergilemektedir (0.430, 0.185, 0.157). Adversarial mesajlar curriculum süreci boyunca da gradient yönünü bozabilmektedir; Byzantine şiddeti kademeli artırılsa bile politika yanlış gradient sinyalleri nedeniyle kilitlenebilmektedir. Bu senaryoda aktif topology izolasyonu kritik öneme sahiptir: C, detector sayesinde Byzantine ajanı grafikten çıkararak 0.628 kapsama ulaşmaktadır.

**Intermittent senaryosunda B ≈ C:** S4 senaryosunda her iki strateji de birbirine çok yakın performans göstermektedir (B: 0.651, C: 0.648). Fault indicator sayesinde B arızalı komşusunun mesajlarını değerlendirmeyi öğrenirken, C detector'ün dinamik kararlarıyla ajanı yalnızca gerçekten arızalı olduğu anlarda izole eder. İki mekanizma da stokastik dropout karşısında benzer düzeyde etkilidir.
...
Müfredat öğrenmesi (Strateji B) arıza şiddetini kademeli olarak artırarak fail-stop ve intermittent senaryolarda stabil öğrenme sağlamaktadır. Ancak Byzantine senaryosunda curriculum tek başına yetersiz kalmakta; adversarial mesajlar düşük intensity'de bile gradient yönünü bozabilmekte ve sonuçlar seed'e göre büyük varyans göstermektedir (0.430–0.157).
